...
class ProcedureTests(unittest.TestCase):
    ...
    def implProcedure1(self, inst):
        ...
        self.assertEqual(inst.occurrencePeriod.end.date, FHIRDate("2013-01-28T14:27:00+01:00").date)
        self.assertEqual(inst.occurrencePeriod.end.as_json(), "2013-01-28T14:27:00+01:00")
        self.assertEqual(inst.occurrencePeriod.start.date, FHIRDate("2013-01-28T13:31:00+01:00").date)
        self.assertEqual(inst.occurrencePeriod.start.as_json(), "2013-01-28T13:31:00+01:00")
    ...
    def implProcedure3(self, inst):
        ...
        self.assertEqual(inst.contained[0].id, "example-pacemaker")
        ...
        self.assertEqual(inst.occurrenceDateTime.date, FHIRDate("2015-04-05").date)
        self.assertEqual(inst.occurrenceDateTime.as_json(), "2015-04-05")
    ...
    def implProcedure5(self, inst):
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.occurrencePeriod.end.date, FHIRDate("2013-03-22T10:30:10+01:00").date)
        self.assertEqual(inst.occurrencePeriod.end.as_json(), "2013-03-22T10:30:10+01:00")
        self.assertEqual(inst.occurrencePeriod.start.date, FHIRDate("2013-03-22T09:30:10+01:00").date)
        self.assertEqual(inst.occurrencePeriod.start.as_json(), "2013-03-22T09:30:10+01:00")
    ...
    def implProcedure9(self, inst):
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.occurrencePeriod.end.date, FHIRDate("2013-03-24T10:30:10+01:00").date)
        self.assertEqual(inst.occurrencePeriod.end.as_json(), "2013-03-24T10:30:10+01:00")
        self.assertEqual(inst.occurrencePeriod.start.date, FHIRDate("2013-03-24T09:30:10+01:00").date)
        self.assertEqual(inst.occurrencePeriod.start.as_json(), "2013-03-24T09:30:10+01:00")
        self.assertEqual(inst.outcome.text, "removal of the retropharyngeal abscess")
        self.assertEqual(inst.performer[0].function.coding[0].code, "01.000")
        self.assertEqual(inst.performer[0].function.coding[0].display, "Arts")
        self.assertEqual(inst.performer[0].function.coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.111")
    ...
    def implProcedure10(self, inst):
        ...
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.note[0].text, "Routine Appendectomy. Appendix was inflamed and in retro-caecal position")
        self.assertEqual(inst.occurrenceDateTime.date, FHIRDate("2013-04-05").date)
        self.assertEqual(inst.occurrenceDateTime.as_json(), "2013-04-05")
