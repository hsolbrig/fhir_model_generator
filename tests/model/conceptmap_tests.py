...
class ConceptMapTests(unittest.TestCase):
    ...
    def implConceptMap1(self, inst):
        ...
        self.assertEqual(inst.group[0].element[0].target[0].relationship, "equivalent")
        ...
        self.assertEqual(inst.group[0].element[1].target[0].relationship, "equivalent")
        ...
        self.assertEqual(inst.group[0].element[2].target[0].relationship, "equivalent")
        ...
        self.assertEqual(inst.group[0].element[3].target[0].relationship, "not-related-to")
    ...
    def implConceptMap3(self, inst):
        ...
        self.assertEqual(inst.group[0].element[3].target[0].relationship, "equivalent")
        ...
        self.assertEqual(inst.group[0].element[4].target[0].relationship, "equivalent")
        ...
        self.assertEqual(inst.group[0].element[5].target[0].relationship, "equivalent")
        ...
        self.assertEqual(inst.group[0].element[6].target[0].relationship, "equivalent")
        self.assertEqual(inst.group[0].element[7].code, "ASERU")
        self.assertEqual(inst.group[0].element[7].target[0].comment, "pending")
        self.assertEqual(inst.group[0].element[7].target[0].relationship, "not-related-to")
        ...
        self.assertEqual(inst.group[0].element[8].target[0].relationship, "equivalent")
        self.assertEqual(inst.group[0].element[9].code, "ATTE")
        self.assertEqual(inst.group[0].element[9].target[0].comment, "TBD")
        self.assertEqual(inst.group[0].element[9].target[0].relationship, "not-related-to")
