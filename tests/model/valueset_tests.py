...
class ValueSetTests(unittest.TestCase):
    ...
    def implValueSet3(self, inst):
        ...
        self.assertEqual(inst.expansion.contains[0].property[0].code, "PROPERTY")
        self.assertEqual(inst.expansion.contains[0].property[0].valueCode, "SCnc")
        ...
        self.assertEqual(inst.expansion.contains[1].contains[0].property[0].code, "PROPERTY")
        self.assertEqual(inst.expansion.contains[1].contains[0].property[0].valueCode, "SCnc")
        ...
        self.assertEqual(inst.expansion.contains[1].contains[1].property[0].code, "PROPERTY")
        self.assertEqual(inst.expansion.contains[1].contains[1].property[0].valueCode, "MCnc")
        ...
        self.assertEqual(inst.expansion.contains[1].contains[2].property[0].code, "PROPERTY")
        self.assertEqual(inst.expansion.contains[1].contains[2].property[0].valueCode, "Prctl")
        ...
        self.assertEqual(inst.expansion.contains[2].contains[0].property[0].code, "PROPERTY")
        self.assertEqual(inst.expansion.contains[2].contains[0].property[0].valueCode, "SCnc")
        ...
        self.assertEqual(inst.expansion.contains[2].contains[1].property[0].code, "PROPERTY")
        self.assertEqual(inst.expansion.contains[2].contains[1].property[0].valueCode, "SCnc")
        ...
        self.assertEqual(inst.expansion.contains[2].contains[2].property[0].code, "PROPERTY")
        self.assertEqual(inst.expansion.contains[2].contains[2].property[0].valueCode, "SCnc")
        ...
        self.assertEqual(inst.expansion.contains[2].contains[3].property[0].code, "PROPERTY")
        self.assertEqual(inst.expansion.contains[2].contains[3].property[0].valueCode, "SCnc")
        ...
        self.assertEqual(inst.expansion.property[0].code, "PROPERTY")
        self.assertEqual(inst.expansion.property[0].uri, "http://loinc.org/property/PROPERTY")
    ...
    def implValueSet5(self, inst):
        ...
        self.assertEqual(inst.compose.property[0], "status")
        self.assertEqual(inst.contact[0].name, "FHIR project team")
        self.assertEqual(inst.contact[0].telecom[0].system, "url")
        self.assertEqual(inst.contact[0].telecom[0].value, "http://hl7.org/fhir")
    ...
    def implValueSet7(self, inst):
        ...
        self.assertEqual(inst.date.date, FHIRDate("2019-11-14T16:57:43+00:00").date)
        self.assertEqual(inst.date.as_json(), "2019-11-14T16:57:43+00:00")
        ...
        self.assertEqual(inst.meta.lastUpdated.date, FHIRDate("2019-11-14T16:57:43.889+00:00").date)
        self.assertEqual(inst.meta.lastUpdated.as_json(), "2019-11-14T16:57:43.889+00:00")
        self.assertEqual(inst.meta.profile[0], "http://hl7.org/fhir/StructureDefinition/shareablevalueset")
