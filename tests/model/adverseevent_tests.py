...
import unittest
import json
from model import adverseevent
...
class AdverseEventTests(unittest.TestCase):
    ...
    def implAdverseEvent1(self, inst):
        ...
        self.assertEqual(inst.occurrenceDateTime.date, FHIRDate("2017-01-29T12:34:56+00:00").date)
        self.assertEqual(inst.occurrenceDateTime.as_json(), "2017-01-29T12:34:56+00:00")
