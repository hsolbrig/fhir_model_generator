...
import unittest
import json
from model import imagingstudy
...
class ImagingStudyTests(unittest.TestCase):
    ...
    def implImagingStudy1(self, inst):
        ...
        self.assertEqual(inst.procedure[1].valueCodeableConcept.coding[0].code, "RPID2589")
        self.assertEqual(inst.procedure[1].valueCodeableConcept.coding[0].display, "XR Wrist 3+ Views")
        self.assertEqual(inst.procedure[1].valueCodeableConcept.coding[0].system, "http://www.radlex.org")
        self.assertEqual(inst.procedure[1].valueCodeableConcept.text, "XR Wrist 3+ Views")
