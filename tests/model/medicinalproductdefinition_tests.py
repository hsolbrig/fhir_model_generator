...
import unittest
import json
from model import medicinalproductdefinition
...
class MedicinalProductDefinitionTests(unittest.TestCase):
    ...
    def implMedicinalProductDefinition1(self, inst):
        ...
        self.assertEqual(inst.manufacturingBusinessOperation[0].effectiveDate.start.date, FHIRDate("2013-03-15").date)
        self.assertEqual(inst.manufacturingBusinessOperation[0].effectiveDate.start.as_json(), "2013-03-15")
