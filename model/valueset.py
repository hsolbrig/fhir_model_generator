...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-f80db8871 (http://hl7.org/fhir/StructureDefinition/ValueSet) on 2019-11-18.
...
class ValueSetExpansionContainsProperty(BackboneElement):
    ...
    """
    resource_type: ClassVar[str] = "ValueSetExpansionContainsProperty"
...
class ValueSetExpansionProperty(BackboneElement):
    ...
    """
    resource_type: ClassVar[str] = "ValueSetExpansionProperty"
...
class ValueSetExpansionContains(BackboneElement):
    ...
    property: Optional[List[ValueSetExpansionContainsProperty]] = None
...
class ValueSetExpansion(BackboneElement):
    ...
    property: Optional[List[ValueSetExpansionProperty]] = None
    contains: Optional[List[ValueSetExpansionContains]] = None
