...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.2.11917 (http://hl7.org/fhir/StructureDefinition/Task) on 2019-11-17.
...
@dataclass
class TaskRequester(BackboneElement):
    """ Who is asking for task to be done.

    The creator of the task.
    """
    resource_type: ClassVar[str] = "TaskRequester"
...
class Task(DomainResource):
    ...
    definitionReference: Optional[FHIRReference] = field(default=None, metadata=dict(one_of_many='definition',))
    ...
    requester: Optional[TaskRequester] = None
