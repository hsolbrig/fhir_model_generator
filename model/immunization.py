...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-f80db8871 (http://hl7.org/fhir/StructureDefinition/Immunization) on 2019-11-18.
...
class Immunization(DomainResource):
    ...
    informationSourceCodeableConcept: Optional[CodeableConcept] = field(default=None, metadata=dict(one_of_many='informationSource',))
    informationSourceReference: Optional[FHIRReference] = field(default=None, metadata=dict(one_of_many='informationSource',))
