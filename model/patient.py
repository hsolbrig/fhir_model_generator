...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.2.11917 (http://hl7.org/fhir/StructureDefinition/Patient) on 2019-11-17.
...
class PatientAnimal(BackboneElement):
    ...
    """
    resource_type: ClassVar[str] = "PatientAnimal"

    species: CodeableConcept = None
    breed: Optional[CodeableConcept] = None
    genderStatus: Optional[CodeableConcept] = None
...
class Patient(DomainResource):
    ...
    animal: Optional[PatientAnimal] = None
