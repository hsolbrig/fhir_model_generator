...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.2.11917 (http://hl7.org/fhir/StructureDefinition/DocumentManifest) on 2019-11-17.
...
@dataclass
class DocumentManifestContent(BackboneElement):
    """ The items included.

    The list of Documents included in the manifest.
    """
    resource_type: ClassVar[str] = "DocumentManifestContent"

    pAttachment: Attachment = field(default=None, metadata=dict(one_of_many='p',))
    pReference: FHIRReference = field(default=None, metadata=dict(one_of_many='p',))
...
class DocumentManifest(DomainResource):
    ...
    content: List[DocumentManifestContent] = field(default_factory=list)
