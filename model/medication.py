...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-f80db8871 (http://hl7.org/fhir/StructureDefinition/Medication) on 2019-11-17.
...
class MedicationIngredient(BackboneElement):
    ...
    strengthRatio: Optional[Ratio] = field(default=None, metadata=dict(one_of_many='strength',))
    strengthCodeableConcept: Optional[CodeableConcept] = field(default=None, metadata=dict(one_of_many='strength',))
