...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-f80db8871 (http://hl7.org/fhir/StructureDefinition/MedicationAdministration) on 2019-11-18.
...
class MedicationAdministration(DomainResource):
    ...
    occurenceDateTime: FHIRDate = field(default=None, metadata=dict(one_of_many='occurence',))
    occurencePeriod: Period = field(default=None, metadata=dict(one_of_many='occurence',))
