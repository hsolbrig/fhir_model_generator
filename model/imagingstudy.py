...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.2.11917 (http://hl7.org/fhir/StructureDefinition/ImagingStudy) on 2019-11-17.
...
class ImagingStudy(DomainResource):
    ...
    uid: str = None
    accession: Optional[Identifier] = None
    identifier: Optional[List[Identifier]] = None
    availability: Optional[str] = None
    modalityList: Optional[List[Coding]] = None
    ...
    numberOfInstances: Optional[int] = None
    procedureReference: Optional[List[FHIRReference]] = None
