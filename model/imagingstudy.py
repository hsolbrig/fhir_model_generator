...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-f80db8871 (http://hl7.org/fhir/StructureDefinition/ImagingStudy) on 2019-11-18.
...
class ImagingStudy(DomainResource):
    ...
    numberOfInstances: Optional[int] = None
    procedure: Optional[List[ImagingStudyProcedure]] = None
