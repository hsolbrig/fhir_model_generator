...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-f80db8871 (http://hl7.org/fhir/StructureDefinition/CommunicationRequest) on 2019-11-18.
...
class CommunicationRequestPayload(BackboneElement):
    ...
    contentCodeableConcept: CodeableConcept = field(default=None, metadata=dict(one_of_many='content',))
...
class CommunicationRequest(DomainResource):
    ...
    informationProvider: Optional[List[FHIRReference]] = None
