...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.2.11917 (http://hl7.org/fhir/StructureDefinition/Condition) on 2019-11-17.
...
class Condition(DomainResource):
    ...
    abatementBoolean: Optional[bool] = field(default=None, metadata=dict(one_of_many='abatement',))
    ...
    assertedDate: Optional[FHIRDate] = None
    asserter: Optional[FHIRReference] = None
    stage: Optional[ConditionStage] = None
