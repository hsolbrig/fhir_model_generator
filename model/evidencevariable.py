...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-f80db8871 (http://hl7.org/fhir/StructureDefinition/EvidenceVariable) on 2019-11-18.
...
class EvidenceVariableCharacteristic(BackboneElement):
    ...
    booleanSet: Optional[List[str]] = None
...
class EvidenceVariable(DomainResource):
    ...
    characteristic: Optional[List[EvidenceVariableCharacteristic]] = None