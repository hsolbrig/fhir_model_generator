...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.1.0-f80db8871 (http://hl7.org/fhir/StructureDefinition/CarePlan) on 2019-11-18.
...
class CarePlan(DomainResource):
    ...
    addressesCode: Optional[List[CodeableConcept]] = None
    addressesReference: Optional[List[FHIRReference]] = None
