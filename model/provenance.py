...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.2.11917 (http://hl7.org/fhir/StructureDefinition/Provenance) on 2019-11-17.
...
class ProvenanceAgent(BackboneElement):
    ...
    relatedAgentType: Optional[CodeableConcept] = None
...
class ProvenanceEntity(BackboneElement):
    ...
    role: str = None
    whatUri: str = field(default=None, metadata=dict(one_of_many='what',))
    whatReference: FHIRReference = field(default=None, metadata=dict(one_of_many='what',))
    whatIdentifier: Identifier = field(default=None, metadata=dict(one_of_many='what',))
...
class Provenance(DomainResource):
    ...
    reason: Optional[List[Coding]] = None
    activity: Optional[Coding] = None
