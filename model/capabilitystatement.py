...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 3.0.2.11917 (http://hl7.org/fhir/StructureDefinition/CapabilityStatement) on 2019-11-17.
...
@dataclass
class CapabilityStatementMessagingEvent(BackboneElement):
    """ Declare support for this event.

    A description of the solution's support for an event at this end-point.
    """
    resource_type: ClassVar[str] = "CapabilityStatementMessagingEvent"
...
@dataclass
class CapabilityStatementRestSecurityCertificate(BackboneElement):
    """ Certificates associated with security profiles.
    """
    resource_type: ClassVar[str] = "CapabilityStatementRestSecurityCertificate"
...
class CapabilityStatementRestSecurity(BackboneElement):
    ...
    certificate: Optional[List[CapabilityStatementRestSecurityCertificate]] = None
...
class CapabilityStatementRestResource(BackboneElement):
    ...
    documentation: Optional[str] = None
    interaction: List[CapabilityStatementRestResourceInteraction] = field(default_factory=list)
...
class CapabilityStatementRestOperation(BackboneElement):
    ...
    """
    resource_type: ClassVar[str] = "CapabilityStatementRestOperation"
...
class CapabilityStatementRest(BackboneElement):
    ...
    searchParam: Optional[List[CapabilityStatementRestResourceSearchParam]] = None
    operation: Optional[List[CapabilityStatementRestOperation]] = None
...
class CapabilityStatementMessaging(BackboneElement):
    ...
    event: Optional[List[CapabilityStatementMessagingEvent]] = None
